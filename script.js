(function () {
  const translations = {
    ar: {
      ...
      prompt: "يسعدنا إقامتك معنا 🌊<br>رأيك يفرق معانا كتير، اختار المنصة اللي يريحك وسيبلنا تقييمك",
      chooseLabel: "اختار منصة التقييم",
      thanks: 'شكرًا لثقتك فينا <span class="heart">♥</span> — تقييمك بيساعدنا نكمل نقدملك تجربة أحلى',
